...
import price_forecaster.dnn_forecast as dnn_forecast
...
output_directory = '/Users/josephcary/Library/CloudStorage/OneDrive-Nexus365/First Year/Papers/Interconnection/Forecasting/Output Data/DNN/'
...
async def main():
    ...
    # )
    dnn_forecast.optimise_hyperparameters(
        input_data_filepath,
        output_hyperparameters_folder_path=output_directory,
        start_test_date='2022-01-01',
        end_test_date='2022-01-30'
    )
